...
For individuals inclined to reach the bottom of the rabbit hole and that want to handle this manually, the use of an oscilloscope is mandatory. Majority of the necessary resources are available directly on the Trinamics TMC website:
  ...
  2. Then to tune the parameters, have a look at the application notes available on their platform, especially [AN001](https://www.analog.com/en/resources/app-notes/an-001.html), [AN002](https://www.analog.com/en/resources/app-notes/an-002.html), [AN003](https://www.analog.com/en/resources/app-notes/an-003.html) and [AN009](https://web.archive.org/web/20220706222150/https://www.trinamic.com/fileadmin/assets/Support/AppNotes/AN009_Tuning_coolStep.pdf).
  3. For a more comprehensive understanding, you might also want to explore [AN015](https://www.analog.com/en/resources/app-notes/an-015.html) and [AN021](https://web.archive.org/web/20230404193136/https://www.trinamic.com/fileadmin/assets/Support/AppNotes/AN021-StealthChop_Performance_comparison_V1.12.pdf), although they are more geared towards enhancing comprehension than calibration, akin to the TMC datasheet.
